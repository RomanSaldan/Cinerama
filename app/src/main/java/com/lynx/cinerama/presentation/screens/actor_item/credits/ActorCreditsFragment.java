package com.lynx.cinerama.presentation.screens.actor_item.credits;
...
public class ActorCreditsFragment extends BaseFragment<ActorItemActivity> implements ActorCreditsContract.ActorCreditsView {
    ...
    public void openMovieScreen(int movieID) {
        MovieItemActivity_.intent(getActivity())
                .movieID(movieID)
                .start();
        getActivity().finish();
    }
