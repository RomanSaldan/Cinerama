package com.lynx.cinerama.presentation.screens.movie_item.info;
...
import com.lynx.cinerama.presentation.screens.movie_item.MovieItemActivity;
import com.lynx.cinerama.presentation.screens.movie_item.info.fullscreen_poster.FullscreenPosterActivity_;
import com.lynx.cinerama.presentation.screens.movie_item.info.review_details.ReviewDetailsActivity_;
import com.lynx.cinerama.presentation.screens.movie_item.info.similar_details.SimilarDetailsActivity_;
...
public class MovieInfoFragment extends BaseFragment<MovieItemActivity> implements MovieInfoContract.MovieInfoView {
    ...
    public void startActorInfoScreen(View v, int actorID) {
        ...
        ActorItemActivity_.intent(getActivity())
                .actorID(actorID)
                .withOptions(options.toBundle())
                .start();
        getActivity().finish();
